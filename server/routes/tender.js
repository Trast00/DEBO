...
import { postTender, getTenders, getTenderById, updateTender, deleteTender, searchTender, getTenderByCountries } from '../controllers/tendersController.js';
console.log("Start Tender Routing")
const router = express.Router();

router.get('/api/tenders', getTenders);
router.post('/api/tenders/search', searchTender);
router.post('/api/tenders/countries', getTenderByCountries);
