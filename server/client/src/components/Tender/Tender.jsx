...
const Tender = ({tender, isHidden=false, isSaved, userUuid, updateHiddenTenderById, updateSaveTenderById, showModal, isPremuim}) => {
  ...
  return (
    <div className="tender" data-tender-id={_id}>
      ...
      <div className="tender-buttons d-flex justify-content-between">
        ...
        {isPremuim && (
          ...
          <div>
              <a href={pdfUrl} target="_blank" rel="noreferrer" className="dowload-file modal-only button-default mb-2">Accedez au document</a>
